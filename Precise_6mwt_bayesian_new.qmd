...
#density estimation
library(tidyverse)
den <- density(MD_smwt, from = -5, to = 40)
...
#density estimation
library(tidyverse)
den_ske <- density(MD_smwt_ske, from = -5, to = 40)
...
#construct probability plot for given effect sizes
es_ske <- seq(from=-5,to=40,by=0.5)
prob_es_ske <- c()
...
#density estimation
library(tidyverse)
den_ent <- density(MD_smwt_ent, from = -5, to = 40)
...
#construct probability plot for given effect sizes
es_ent <- seq(from=-5,to=40,by=0.5)
prob_es_ent <- c()
