...
#density estimation
library(tidyverse)
den <- density(MD_dmv, from = -2, to = 4)
...
#density estimation
library(tidyverse)
den_lit <- density(MD_dmv_lit, from = -2, to = 4)
...
#construct probability plot for given effect sizes
es_lit <- seq(from=-2,to=4,by=0.05)
prob_es_lit <- c()
...
#density estimation
library(tidyverse)
den_ske <- density(MD_dmv_ske, from = -2, to = 4)
...
#construct probability plot for given effect sizes
es_ske <- seq(from=-2,to=4,by=0.05)
prob_es_ske <- c()
...
#density estimation
library(tidyverse)
den_ent <- density(MD_dmv_ent, from = -2, to = 4)
...
#construct probability plot for given effect sizes
es_ent <- seq(from=-2,to=4,by=0.05)
prob_es_ent <- c()
