...
mcid_mort <- 0.05
prob_ARD_mort_MCID <- sum(ARD.mort > mcid_mort)/length(ARD.mort)
#clinically important harm P(ARD> -MCID)
prob_ARD_mort_harm <- sum(ARD.mort < -mcid_mort)/length(ARD.mort)
...
md_plot1 <- ggplot(data_dens_plot, aes(x, y)) + geom_line(col="gold") +
  ...
  geom_vline(xintercept=mcid_mort, col="black", lty = 3) + 
  xlim(-0.1,0.2) + xlab("ARD") + ylab("") +
  annotate("text", x = mcid_mort+0.001, y = 1, label = "MCID") + 
...
#clinically important benefit P(ARD>MCID)
mcid_mort_lit <- 0.05
prob_ARD_mort_MCID_lit <- sum(ARD.mort_lit > mcid_mort_lit)/length(ARD.mort_lit)
#clinically important harm P(ARD> -MCID)
prob_ARD_mort_harm_lit <- sum(ARD.mort_lit < -mcid_mort_lit)/length(ARD.mort_lit)
...
md_plot1_lit <- ggplot(data_dens_plot_lit, aes(x, y)) + geom_line(col="gold") +
  ...
  geom_vline(xintercept=mcid_mort, col="black", lty = 3) + 
  xlim(-0.1,0.2) + xlab("ARD") + ylab("") +
  annotate("text", x = mcid_mort+0.001, y = 10, label = "MCID") + 
...
#clinically important benefit P(ARD>MCID)
mcid_mort_ske <- 0.05
prob_ARD_mort_MCID_ske <- sum(ARD.mort_ske > mcid_mort_ske)/length(ARD.mort_ske)
#clinically important harm P(ARD> -MCID)
prob_ARD_mort_harm_ske <- sum(ARD.mort_ske < -mcid_mort_ske)/length(ARD.mort_ske)
...
#clinically important benefit P(ARD>MCID)
mcid_mort_ent <- 0.05
prob_ARD_mort_MCID_ent <- sum(ARD.mort_ent > mcid_mort_ent)/length(ARD.mort_ent)
#clinically important harm P(ARD> -MCID)
prob_ARD_mort_harm_ent <- sum(ARD.mort_ent < -mcid_mort_ent)/length(ARD.mort_ent)
...
tab_mort_res <- matrix(NA,5,3)
rownames(tab_mort_res) <- c("risk(95%CI) mort","OR(95%CI) mort","P(>0)","P(>MCID)","P(>-MCID)")
...
tab_mort_res_lit <- matrix(NA,5,3)
rownames(tab_mort_res_lit) <- c("risk(95%CI) mort","OR(95%CI) mort","P(>0)","P(>MCID)","P(>-MCID)")
...
tab_mort_res_ske <- matrix(NA,5,3)
rownames(tab_mort_res_ske) <- c("risk(95%CI) mort","OR(95%CI) mort","P(>0)","P(>MCID)","P(>-MCID)")
...
tab_mort_res_ent <- matrix(NA,5,3)
rownames(tab_mort_res_ent) <- c("risk(95%CI) mort","OR(95%CI) mort","P(>0)","P(>MCID)","P(>-MCID)")
